...
using Examination.Areas.Admin.Models.SuperAdminViewModels;
...
namespace Examination.Areas.Admin.Controllers
{
    ...
    public class SuperAdminController : Controller
    {
        ...
        public SuperAdminController(UserManager<ApplicationUser> userMgr,
            ...
            IPasswordHasher<ApplicationUser> passHasher, IAsyncRepository<User> UserRepository)
        {
            userManager = userMgr;
        ...
        public async Task<IActionResult> Edit(string Id, string userName, string email, decimal Price)
        {
            ApplicationUser user = await userManager.FindByIdAsync(Id);
