...
using Examination.Areas.Admin.Models.RoleViewModels;
...
namespace Examination.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(RoleManager<ApplicationRole> roleMgr, UserManager<ApplicationUser> userMgr)
        {
            roleManager = roleMgr;
            userManager = userMgr;
        }
        ...
        public async Task<IActionResult> Edit(ModifyRoleVm modifyRole)
        {
            ...
            if (ModelState.IsValid)
            {
                ApplicationRole role = await roleManager.FindByIdAsync(modifyRole.RoleId);
