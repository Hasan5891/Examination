...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Examination.Data.Abiturient", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Examination.Data.PartA", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Examination.Data.TestA", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Examination.Data.Abiturient", b =>
                {
                    b.HasOne("Examination.Data.PartA", "PartA")
                        .WithMany()
            ...
            modelBuilder.Entity("Examination.Data.TestA", b =>
                {
                    b.HasOne("Examination.Data.Abiturient", "Abiturient")
                        .WithMany("Tests")
            ...
            modelBuilder.Entity("Examination.Data.UserExams", b =>
                {
                    b.HasOne("Examination.Data.Abiturient")
                        .WithMany("UserExams")
                        .HasForeignKey("AbiturientID");
